...
import { Eye, Pencil, Trash2, Search, SlidersHorizontal, Calendar } from "lucide-react";
...
export default function OrdersPage() {
  ...
  const filteredOrders = orders.filter(order => {
    ...
    const matchesAmount = 
      (!filters.minAmount || order.amount >= parseFloat(filters.minAmount)) &&
      (!filters.maxAmount || order.amount <= parseFloat(filters.maxAmount));
              ...
              <TableRow key={order.id}>
                ...
                <TableCell>
                  <div className="flex flex-col">
                    ...
                    <span className="text-sm text-muted-foreground">{order.customer.businessName}</span>
                  </div>
                </TableCell>
                <TableCell>
                  <div className="flex flex-col">
                    <span>{order.product.name}</span>
                    <span className="text-sm text-muted-foreground">{order.product.category}</span>
                  </div>
                </TableCell>
