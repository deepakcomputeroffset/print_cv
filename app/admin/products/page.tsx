...
//   // Recursive function to get all categories for select
//   const getAllCategories = (categories: Category[], level = 0): JSX.Element[] => {
...
//                   <Input type="number" id="minQty" placeholder="Minimum quantity" />
//                 </div>
//               </div>
...
//                   <Input type="number" id="avgPrice" placeholder="Avg price" />
//                 </div>
//                 <div className="grid gap-2">
...
//                   </div>
//                 </TableCell>
//                 <TableCell>{product.product_items[0]?.product_code}</TableCell>
//                 <TableCell>
//                   ₹{product.product_items[0]?.min_price} - ₹{product.product_items[0]?.max_price}
//                 </TableCell>
//                 <TableCell>
...
//                           <div className="grid gap-2">
//                             <Label htmlFor="category">Category</Label>
//                             <Select defaultValue={product.category_id.toString()}>
//                               <SelectTrigger>
//                                 <SelectValue placeholder="Select category" />
//                               </SelectTrigger>
//                               <SelectContent>
...
//                           <div className="grid gap-2">
//                             <Label htmlFor="image">Image URL</Label>
//                             <Input id="image" defaultValue={product.image_url[0]} />
//                           </div>
//                           <div className="grid grid-cols-2 gap-4">
//                             <div className="grid gap-2">
//                               <Label htmlFor="productCode">Product Code</Label>
//                               <Input
//                                 id="productCode"
//                                 defaultValue={product.product_items[0]?.product_code}
//                               />
//                             </div>
//                             <div className="grid gap-2">
//                               <Label htmlFor="minQty">Minimum Quantity</Label>
...
//                                 type="number"
//                                 id="minQty"
//                                 defaultValue={product.product_items[0]?.min_qty}
//                               />
//                             </div>
//                           </div>
//                           <div className="grid grid-cols-3 gap-4">
...
//                                 type="number"
//                                 id="minPrice"
//                                 defaultValue={product.product_items[0]?.min_price}
//                               />
//                             </div>
//                             <div className="grid gap-2">
//                               <Label htmlFor="avgPrice">Average Price</Label>
...
//                                 type="number"
//                                 id="avgPrice"
//                                 defaultValue={product.product_items[0]?.avg_price}
//                               />
//                             </div>
//                             <div className="grid gap-2">
//                               <Label htmlFor="maxPrice">Maximum Price</Label>
...
//                                 type="number"
//                                 id="maxPrice"
//                                 defaultValue={product.product_items[0]?.max_price}
//                               />
//                             </div>
//                           </div>
//                         </div>
