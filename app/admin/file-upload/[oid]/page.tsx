...
export default async function UploadFilesPage({
    ...
    try {
                    ...
                    <div className="min-h-[80vh] flex items-center justify-center">
                        <div className="bg-white p-8 rounded-xl shadow-lg max-w-md w-full">
                            <div className="text-center">
                                ...
                                <p className="text-gray-600 mb-6">
                                    All required files have already been
        ...
        if (orderDetails?.uploadFilesVia !== "EMAIL") {
            return (
                <div>
                    <div className="flex items-center gap-3 mb-6">
                        <SidebarTrigger className="w-8 h-8" />
                    ...
                    <div className="min-h-[80vh] flex items-center justify-center">
                        <div className="bg-white p-8 rounded-xl shadow-lg max-w-md w-full">
                            <div className="text-center">
                                ...
                                <p className="text-gray-600 mb-6">
                                    Files will be uploaded by customer
                                </p>
                                <Button
                                    href={
                                        "/admin/file-upload?search=&sortorder=desc&orderStatus=ALL&page=1&perpage=100"
        ...
        return (
            <div>
                ...
                <FileUploadPage order={transformedOrder} />;
            </div>
        );
    } catch (error) {
