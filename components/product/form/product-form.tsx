...
export function ProductForm() {
    ...
    const {
        ProductAttributeTypes: avialable_product_attribute_types,
        createProductAttributeType: {
            mutateAsync: createProductAttribute,
            isPending: isProductAttributeCreating,
        },
        deleteProductAttributeType: {
            mutateAsync: deleteProductAttributeType,
            isPending: isAttributeDeleting,
        },
    ...
    const handleVariantsGenerated = (newVariants: Variant[]) => {
        ...
        <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                ...
                <ProductAttributes
                    ...
                    deleteProductAttributeType={deleteProductAttributeType}
                    isAttributeDeleting={isAttributeDeleting}
                    isProductAttributeCreating={isProductAttributeCreating}
                    isLoading={isLoading || isProductCreating}
