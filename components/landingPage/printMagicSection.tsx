...
export default function PrintMagicSection() {
    return (
        <section
        // className={cn(
        //     "relative overflow-hidden px-[5vw] h-full bg-[#eda371] flex justify-center items-center py-20 mx-auto",
        //     sourceSerif4.className,
        // )}
        >
            <div
                className={cn(
                    "relative overflow-hidden rounded-md mt-10 px-10 h-full bg-[#eda371] flex justify-center items-center py-20 mx-auto",
                    sourceSerif4.className,
                )}
            >
                <div className="relative w-full h-full flex items-center justify-between bg-transparent z-10 flex-col xl:flex-row space-y-16">
                    <div className="max-w-xl">
                        ...
                        >
                            Join the printing revolution! Our services are
                            tailored to meet your wildest printing dreams. Let’s
                    ...
                    <div className="justify-end pt-[64px] px-[40px] pb-[40px] rounded-xl bg-dominant-color-2 max-w-xl">
                        ...
                        <motion.h4
                            ...
                            viewport={{ once: true }}
                            className="text-white text-[20px] leading-[30px] tracking-[-0.2px]"
                        >
                            Meet our team of printing wizards who turn your
                            ideas into reality. With years of experience, they
                            know how to make your prints shine!
                        </motion.h4>
                        <motion.div
                            initial={{ opacity: 0 }}
                            whileInView={{
                            ...
                            className="mt-[20px]"
                        >
                            <p className="text-white text-[20px] leading-[30px] tracking-[-0.2px]">
                                Deep Singh
                            </p>
                        </motion.div>
                    </div>
