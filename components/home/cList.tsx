        ...
        <div className="flex flex-col space-y-12 2xl:space-y-15">
            ...
            >
                <Link href="/categories">
                    <Button
                        size="sm"
                        className="rounded-xl bg-gradient-to-r from-primary to-cyan-500 hover:from-primary/90 hover:to-cyan-600 text-white shadow-lg hover:shadow-xl group px-8 py-4 h-auto text-base transition-all duration-300 transform hover:scale-[1.02] hover:-translate-y-0.5 relative overflow-hidden"
                    >
