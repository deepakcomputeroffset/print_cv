...
import { getCarouselCreateSchema } from "@/schemas/carousel.form.schema";
...
import { z } from "zod";
import { createCarousel } from "@/app/admin/carousel/_actions/actions";
...
export const CarouselCreateForm = () => {
    ...
    const carouselSchema = getCarouselCreateSchema();
    ...
    const handleSubmit = async (values: z.infer<typeof carouselSchema>) => {
        startTransition(async () => {
            try {
                ...
                await createCarousel(data, image as File);
